...
def _pick_llm_api_key() -> str | None:
    return (
...
def cache_response(func):
    ...
    def wrapper(self, *args, **kwargs):
        ...
        max_completion_tokens = kwargs.get(
            ...
            kwargs.get("max_tokens", gen_params.get("max_completion_tokens", gen_params.get("max_tokens"))),
        )
        reasoning_effort = kwargs.get("reasoning_effort", gen_params.get("reasoning_effort"))
        ...
        with FileLock(lock_file):
            ...
            if row is not None:
                ...
                if hasattr(self, "_record_cache_hit"):
...
class CacheOpenAI(BaseLLM):
    ...
    def __init__(self, cache_dir, global_config, cache_filename: str = None,
        ...
        if high_throughput:
            ...
            client = httpx.Client(limits=limits, timeout=_make_http_timeout())
        else:
            client = None

        self.max_retries = kwargs.get("max_retries", 2)
        api_key = _pick_llm_api_key()
    ...
    def _record_usage(self, metadata: dict | None) -> None:
    ...
    def get_usage_totals(self) -> dict:
        with self._usage_lock:
            return {
                ...
                "completion_tokens": int(self._completion_tokens_total),
                "total_tokens": int(self._prompt_tokens_total + self._completion_tokens_total),
    ...
    def infer(
        ...
        **kwargs
        ...
        if str(params.get("model", "")).startswith("gpt-5") and "reasoning_effort" not in params:
