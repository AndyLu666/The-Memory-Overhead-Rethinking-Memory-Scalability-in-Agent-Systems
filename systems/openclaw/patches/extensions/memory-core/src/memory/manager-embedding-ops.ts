...
const EMBEDDING_BATCH_MAX_TOKENS = readPositiveIntEnv(
  "OPENCLAW_MEMORY_EMBEDDING_BATCH_MAX_TOKENS",
  8000,
);
...
const EMBEDDING_BATCH_TIMEOUT_REMOTE_MS = readPositiveIntEnv(
  "OPENCLAW_MEMORY_EMBEDDING_BATCH_TIMEOUT_REMOTE_MS",
  2 * 60_000,
);
