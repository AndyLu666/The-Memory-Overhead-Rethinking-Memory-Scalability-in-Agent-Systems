...
class QueryTimeStatistic(TimeStatistic):
    ...
    def get_runtime_summary(self) -> Dict[str, Any]:
        """Get detailed MemOS-aligned timing summary for query operations."""
...
class OverallTimeStatistic:
    ...
    def get_comprehensive_summary(self) -> Dict[str, Any]:
        ...
        runtime_summary = self.query_time.get_runtime_summary()
        ...
        return {
            ...
            "runtime_processing": runtime_summary,
            "total_graph_time": graph_summary["total_graph_building_time"],
            "total_runtime_time": runtime_summary["total_query_time"],
            "graph_vs_query_ratio": round(
                graph_summary["total_graph_building_time"] / runtime_summary["total_query_time"], 2
            ) if runtime_summary["total_query_time"] > 0 else 0
        }
